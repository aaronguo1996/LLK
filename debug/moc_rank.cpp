...
static const char qt_meta_stringdata_Rank[] = {
    "Rank\0"
};
...
const QMetaObjectExtraData Rank::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Rank::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Rank,
      qt_meta_data_Rank, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Rank::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Rank))
